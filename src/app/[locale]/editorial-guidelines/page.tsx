...
export default async function EditorialGuidelinesPage({
  ...
  const EDITORIAL_SCHEMA = {
    ...
    "@type": "WebPage",
    "@id": `https://foxiptvpanels.com/${locale}/editorial-guidelines/#webpage`,
    "url": `https://foxiptvpanels.com/${locale}/editorial-guidelines`,
    "name": lc({
  ...
  return (
    <>
      ...
      />
      <link rel="canonical" href={`https://foxiptvpanels.com/${locale}/editorial-guidelines`} />
